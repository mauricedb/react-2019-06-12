...
numbersClicks$.pipe((0, _operators.take)(2), (0, _operators.switchMap)(function (e) {
  return numbers;
...
var subscription = (0, _rxjs.fromEvent)(startTimer, "click").pipe((0, _operators.switchMap)(function () {
